...
rule all:
    input:
        ...
        #
        expand("MULTIQC/single_end/{sample}/{sample}_multiqc_report.html", sample = single_end_samples),
        expand("MULTIQC/{sample}/{sample}_multiqc_report.html", sample = paired_samples),
        #
        ## The lines below will perform multiQC in the filtered and trimmed RNA
        # 
        expand("MULTIQC/sortmerna/{sample}/{sample}_unpaired_multiqc_report.html", sample = single_end_samples),
        expand("MULTIQC/sortmerna/{sample}/{sample}_fwd_paired_multiqc_report.html", sample = paired_samples),
        expand("MULTIQC/trimmomatic/unpaired/{sample}/{sample}_unpaired_multiqc_report.html", sample = single_end_samples),
        expand("MULTIQC/trimmomatic/{sample}/{sample}_paired_multiqc_report.html", sample = paired_samples),
        # 
